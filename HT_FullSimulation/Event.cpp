...
//////////////////////////////////////////////////////////////////////////////////////
        ...
        Event(TrackReader* newRecoTrack, int nTracks, BibFileReader &bibRead, long int backGnd = -1){
        	...
        	//	}
        		...
        		if(verbose) cout << "Created track " << iT << endl;
        	...
        	// shuffle hits
  			...
  			if(verbose) cout << "done shuffling hits" << endl;
  			...
  			for(unsigned iH = 0; iH != hitList.size(); ++iH){
  				...
  				if(trackInd > 0) ((trackList[trackInd-1]).hitList).push_back(*thisHit);
  			}  			
        	if(verbose) cout << "end of Event constructor" << endl; 
