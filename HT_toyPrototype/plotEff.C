...
TGraph* makeEffGraphFromFile(const char * file_num,const char * hist_num,
                             const char * file_den, const char * hist_den) {
...
void plotEff(){
  ...
  TGraph * g_eff = makeEffGraphFromFile("AAAEventGeneration.root","HTrackPhiEff","AAAEventGeneration.root","HTrackPhi");
 ...
 // first canvas position and size
  ...
  Int_t height = 400;
	...
	TGraph * g_eff1 = makeEffGraphFromFile("AAAEventGeneration.root","HTrackPhiEff","AAAEventGeneration.root","HTrackPhi");
  	...
  	TCanvas* c2 = new TCanvas("c2","c2",x1 + width+10 ,y1,width,height);
	TGraph * g_eff2 = makeEffGraphFromFile("AAAEventGeneration.root","HTrackEtaEff","AAAEventGeneration.root","HTrackEta");
  	...
  	TCanvas* c3 = new TCanvas("c3","c3",x1 + 2*width+20,y1,width,height); 	 
	TGraph * g_eff3 = makeEffGraphFromFile("AAAEventGeneration.root","HTrackInvPtEff","AAAEventGeneration.root","HTrackInvPt");
