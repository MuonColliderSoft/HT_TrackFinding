//
//  Geometry_Detector.cpp
//  MuonColliderToy
//
//  Created by Luciano Ristori on 1/26/23.
//
...
class Geometry {
	...
	const double t_phi = 0.0005;
	const double t_deltaPhi = 0.0005;
	
	const double t_eta = 1.0;
	const double t_deltaEta = 1.0;

	const double t_invPt_max = 1./10.; // Gev/c^(-1)  
	...
	Geometry() { // default constructor
		...
		//double zSigmaB = 1.0;// mm
		//double rSigmaD = 1.0;// mm
		
		double xphiSigmaB = 0.;// mm
		double xphiSigmaD = 0.;// mm
		double zSigmaB = 0.;// mm
		double rSigmaD = 0.;// mm
		
		
		double tSigmaB = 0.0;// mm
		double tSigmaD = 0.0;// mm
